...
import { RotateCcw, TrendingUp, HelpCircle } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const fallbackAssessmentData = {
        ...
        aiInsights: (fallbackResult as any).aiInsights || null,
        confidence: (fallbackResult as any).confidence || null,
      };
